...
It takes all known Polarization files, extracts the files used in the crystalline configuration and processes them to be used by *CreateModels/ML/CreateSaveModelCrystalline.ipynb*
...
<h3>After running this notebook please go to CreateModels\ML and run CreateSaveModelCrystalline.ipynb</h3>
