...
It takes the files from *CrystallineToPredictFiles* and predicts with them. There is now only one function that can be used for prediction called *Predict*.
...
3. **CrystallineLogFile_PredictingML.txt**
